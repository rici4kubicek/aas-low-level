...
class MFRC522:
    ...
    def MFRC522_SelectTag2(self, serNum):
        backData = []
        buf = []
    ...
    def MFRC522_NTAG216Auth(self, Sectorkey):
        buff = []
    ...
    def MFRC522_ReadUltralight(self, blockAddr):
        recvData = []
